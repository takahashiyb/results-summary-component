<script setup>
  ...
  // function adjustIconLink(link) {
  //   return link.replace('./', '/results-summary-component/');
  // }
</script>
...
<style scoped>
  ...
  .reaction {
    background-color: hsl(var(--red-050-color));
  ...
  .actual {
    color: hsl(var(--navy-950-color));
    font: var(--font-preset-5-b);
  }
